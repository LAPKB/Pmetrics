...
#' NPex$cycle$plot(linetypes = "dash", colors = "Blues", marker = list(size = 1), line = list(width = 3))#' NPex$cycle$plot(grid = F, xlab = list(bold = F, font = list(color = "red", family = "Arial", size = 10)))
#' @family PMplots
