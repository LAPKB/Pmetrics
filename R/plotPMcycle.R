...
#'
#' Plot PM_cycle objects
#'
#' @method plot PM_cycle
#' @param x The name of a [PM_cycle]  object generated by [makeCycle].
...
plot.PM_cycle <- function(x, 
  ...
  #LL
  graph_data <- tibble::tibble(cyc = include, ll = data$ll[include])
...
#' `PM_result$cycle$data`.  It is largely now a legacy plotting function, with a variety of options.
#'
#' @method plot PMcycle
