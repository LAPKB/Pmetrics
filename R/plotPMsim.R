...
#' named either xaxis or yaxis. See `schema()` layout -> xaxis/yaxis for options.
...
#' by the `probs` argument to the plot call; \emph{prop_less} are the proportion of simulated
