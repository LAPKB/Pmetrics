...
```{r, echo = T, eval = T, label = "data1"}
NPex$data$plot(legend = T)
```

...and a more complex one.
```{r, echo = T, eval = T, label = "data2"}
NPex$data$plot(
...
``` {r echo = T, eval = T, label = "data3"}
NPex$data$plot(xlab = "Time (h)", ylab = "Rifapentine (mg/L)")
```

``` {r echo = T, eval = T, label = "data4"}
