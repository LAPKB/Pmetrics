...
1/6 of the range, i.e. 3 SD above and below the mean. In Legacy Pmetrics
...
in either the \#SECondary block or in the equations directely. Because the Legacy
...
The two defining functions for primary parameters are `ab` and `msd`. 
