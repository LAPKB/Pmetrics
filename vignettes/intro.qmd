...
Data files are generally .csv and the format is detailed in [data](data.html)].
...
and Linux. Instructions on obtaining and installing the package are [here](pmetrics.html).
