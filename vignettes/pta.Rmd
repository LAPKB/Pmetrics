...
We'll say again that you must supply simulation data, which has been previously generated. If you use the `PM_sim$pta()` method, the simulation data are embedded in the object. If you use `PM_pta$new()`, you have to supply the name of a `PM_simlist()` object yourself.
