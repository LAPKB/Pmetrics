...
! Arguments
      ...
      double precision, dimension(1:,1:), intent(inout) :: YO,Y   ! dimension(max_m_per_obs,maxnumeq)
      character*20 ERRFIL

! Local variables

      integer, parameter :: DEBUG = 109          ! write debugging messages
...
! Poisson
          ...
          !
          ! Strategy can not work: The YO that pass the sieve and are processed
...
!               and increases chance for this support point to survive. 
              ...
              if (RPAR(k_resolve) .gt. OBSSWAPPOISSON ) then
                if (YOBSERVED .gt. YMEAN) then
                  ...
                  write (*,*) JSUB,IG,I,J,"Swapped Poisson Obs"
