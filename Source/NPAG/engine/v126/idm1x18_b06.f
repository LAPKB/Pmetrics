...
C               endif
C               if (ig.eq.1) then
C                 write (*,*) "JSUB,IG,M,EQN",JSUB,IG,I,J
C     1             , "is P w/mu,y,err,z^2,Pr="
C     2             , YMEAN,YOBSERVED,ObsError(I,J)
C     3             , RPAR(k_sum_z_sq),poissonprob
C               endif
              ENDIF
...
C               if (ig.eq.1) then
C                 write (*,*) "JSUB,IG,M,EQN",JSUB,IG,I,J
C     1             , "is N w/mu,obs,err,z^2="
C     2             , YMEAN,YOBSERVED,ObsError(I,J)
C     3             , RPAR(k_sum_z_sq)
CC     4             , IPAR(i_errmod), RPAR(k_gamma)
C               endif
