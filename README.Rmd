...
Note: if you are a Windows user and experience an error while installing Pmetrics that mentions `Linker.exe`. That means the Rust toolchain is misconfigured to your system.
