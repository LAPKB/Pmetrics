...
CCC  HERE HERE ... editing GETIX in Pmetrics ... 2017Oct02
...
C Looks OK to here
      write (*,*) JSUB,IG,"FUNC->USER ::",
     1  T,X(1),X(2),X(3),"TOUT=",TOUT,
     2  KNS,KNT,SIGO(KNS),TIM(KNT)
...
c      COMMON /DVOD01/ ACNRM, CCMXJ, CONP, CRATE, DRC, EL(13),
