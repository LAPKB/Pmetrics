...
C  AT ESTML(I) AS DEFINED ABOVE.
	...
	CALL EVAL3(JSUB,IG,NPP,ESTML,NUMT,YYPRED,TPRED,NUMEQT,
     1      NDIM,MF,RTOL,ATOL,INTLIST)
...
!$omp Threadprivate(/PARAMD/,/INPUT/,/CNST/)
...
C        write (*,*) "CALL USERANAL(X,Tin,Tout)", T, TOUT, NDIM, MF
