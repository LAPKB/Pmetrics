...
#' @param usePost Boolean argument.  Only applicable when \code{poppar} is an NPAG \emph{PMfinal} object.
...
# wmy2019.02.27 -- adding npag_utils.f90 to montbig.exe
#
# montbig.exe will ask for model.for, which will also require
#  npag_utils.f90, the pre-compiled sSIMeng required npag_utils.f90
#
# wmy2019.03.25 -- Using NPAG DVODE version (removed from MONTnnn.FOR)
#
# wmy2019.03.25 -- Also, using 0blasnpag.f
#
# Original code: 
...
#  enginefiles <- shQuote(paste(utilsfile, computefile,sep=" "))
...
# wmy2019.02.27
    print(paste(enginecompile,model))
