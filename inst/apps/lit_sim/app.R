...
conditionalPanel(
  ...
  downloadButton("download_corr_csv", "Save", icon = icon("download"), class = "btn-sm btn-outline-success")
),
tags$small(
  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      fluidRow(
        ...
        column(4, downloadButton("download_sim_csv_btn", "Save as CSV", icon = icon("save"), class = "btn-success")),
...
output$download_sim_csv_btn <- downloadHandler(
  filename = function() {
    "theta.csv"
  },
  content = function(file) {
