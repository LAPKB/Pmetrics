...
2. Install [Rstudio](https://www.rstudio.com), which will soon be rebranded as [posit](https://posit.co).
3. Install the *devtools* package into Rstudio. The easiest way is to click the Install button on the Packages tab, and search the CRAN repository for *devtools*.
...
5. Launch Pmetrics in Rstudio with `library(Pmetrics)`
6. Run `PMbuild()` to download necessary components and install them. It might be many components, depending on your system.
