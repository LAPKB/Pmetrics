C  TSTMULTK.FOR                          OCT, 2012
     ...
     &  STREQ
      ...
      DIMENSION X(NDIM),XP(NDIM),P(32),R(37),B(20),CV(26),RATEIV(7)
         ...
         STREQ=CV(18)
         FFMc = FFM/59
         IF(AGE.LT.50) AGEcl=0
         CL = CLmcy*EXP(AGEcl*(AGE-50))*FFMc**0.75
         IF(SEX.GT.0.D0.AND.CYP.GT.0.D0) CL = CLfcy*EXP(AGEcl*(AGE-5
     &   0)*FFMc**0.75
         IF(SEX.LT.1.D0.AND.CYP.LT.1.D0) CL = CLmnocy*EXP(AGEcl*(AGE
     &   -50))*FFMc**0.75
         IF(SEX.GT.0.D0.AND.CYP.LT.1.D0) CL = CLfnocy*EXP(AGEcl*(AGE
     &   -50))*FFMc**0.75
