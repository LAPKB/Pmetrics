...
You can download and install **R** from the [Comprehensive R Archive Network (CRAN)](https://cran.r-project.org/).
...
* One time only, add the LAPKB r-universe repository to your list of repositories by running this command in R.
```{r} 
#| eval: false
...
`install.packages("Pmetrics")` and you can update it with `update.packages("Pmetrics")`. These commands are the same as for any other R package hosted on CRAN. By having the LAPKB repository in your list of repositories, R will automatically find and install/update the correct version of Pmetrics for your system.
